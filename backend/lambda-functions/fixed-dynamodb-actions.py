...
def lambda_handler(event, context):
    try:
        ...
        if function_name == 'get_database_schema':
            ...
            # Buscar conexión por connectionId (sin userId)
            ...
            # Conectar a MySQL usando las credenciales hardcodeadas del .env
            conn = pymysql.connect(
                host='dev-sharktank-mysql.ctowvzhuzenn.us-east-1.rds.amazonaws.com',
                port=3306,
                user='admin',
                password='DemoShark123!',
                database='sharktank_demo'
            )
            ...
            response_text = f"""Base de datos 'sharktank_demo' conectada exitosamente.
...
Puedo ejecutar consultas SQL en estas tablas. ¿Qué consulta específica te gustaría que ejecute?"""
            ...
            # Conectar directamente con credenciales hardcodeadas
            conn = pymysql.connect(
                host='dev-sharktank-mysql.ctowvzhuzenn.us-east-1.rds.amazonaws.com',
                port=3306,
                user='admin',
